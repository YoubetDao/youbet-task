        ...
        <div className="w-full space-y-6 lg:w-1/3">
          ...
          <Card className="space-y-1 rounded-lg p-4 shadow-lg">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center justify-between">
                <p className="text-l mb-2 font-bold text-gray-400">{totalRewards.toFixed(5)} dev</p>
              </div>
            </div>
            <div className="space-y-1">
              <h3 className="text-lg font-semibold text-white">To Claim</h3>
              <div className="flex items-center justify-between">
                <p className="text-l mb-2 font-bold text-gray-400">{(totalRewards - claimedRewards).toFixed(5)} dev</p>
